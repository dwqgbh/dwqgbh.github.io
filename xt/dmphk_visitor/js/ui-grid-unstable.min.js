...
!function () {
            ...
            compile: function () {
                return {
                    pre: function (b, c) {
                        ...
                        var n, o = (angular.element(c[0].querySelectorAll(".ui-grid-header-cell-menu")), angular.element(c[0].querySelectorAll(".ui-grid-cell-contents"))), p = function () {
                            var b = c;
                            n && (b.removeClass(n), n = null), n = angular.isFunction(a.col.headerCellClass) ? a.col.headerCellClass(a.grid, a.row, a.col, a.rowRenderIndex, a.colRenderIndex) : a.col.headerCellClass, b.addClass(n);
                        ...
                        a.$watch("col", function (b, d) {
                            if (b !== d) {
                                ...
                                e !== m && (c.removeClass(m), c.addClass(e), m = e)
                            }
                        }), p();
                        var q = a.grid.registerDataChangeCallback(p, [f.dataChange.COLUMN]);
                        if (a.$on("$destroy", q), a.sortable = k.grid.options.enableSorting && a.col.enableSorting ? !0 : !1, a.filterable = k.grid.options.enableFiltering && a.col.enableFiltering ? !0 : !1, a.colMenu = a.col.grid.options && a.col.grid.options.enableColumnMenus !== !1 && a.col.colDef && a.col.colDef.enableColumnMenu !== !1 ? !0 : !1, a.sortable || a.colMenu) {
                            var r, s = 0, t = e.isTouchEnabled() ? "touchstart" : "mousedown";
                            o.on(t, function (d) {
                                d.stopPropagation(), "undefined" != typeof d.originalEvent && void 0 !== d.originalEvent && (d = d.originalEvent), d.button && 0 !== d.button || (s = (new Date).getTime(), r = b(function () {
                                }, h), r.then(function () {
                                    a.colMenu && k.columnMenuScope.showMenu(a.col, c, d)
                                }), k.fireEvent(f.events.COLUMN_HEADER_CLICK, {
                                    event: d,
                                    columnName: a.col.colDef.name
                                }))
                            });
                            var u = e.isTouchEnabled() ? "touchend" : "mouseup";
                            o.on(u, function () {
                                b.cancel(r)
                            }), a.$on("$destroy", function () {
                                o.off("mousedown touchstart")
                            })
                        }
                        if (a.toggleMenu = function (b) {
                            ...
                            var v = e.isTouchEnabled() ? "touchend" : "click";
                            o.on(v, function (a) {
                                a.stopPropagation(), b.cancel(r);
                                var c = (new Date).getTime(), d = c - s;
                                d > h || j(a)
                            }), a.$on("$destroy", function () {
                                b.cancel(r)
                            })
                        ...
                        if (a.filterable) {
                            ...
                            angular.forEach(a.col.filters, function (b, c) {
                                w.push(a.$watch("col.filters[" + c + "].term", function (a, b) {
                                    a !== b && (k.grid.api.core.raise.filterChanged(), k.grid.refresh().then(function () {
                                        if (k.prevScrollArgs && k.prevScrollArgs.y && k.prevScrollArgs.y.percentage) {
                                            var a = new g(k.grid, null, null, "uiGridHeaderCell.toggleMenu");
                                            a.y.percentage = k.prevScrollArgs.y.percentage, a.fireScrollingEvent()
                                        }
                                    }))
                                }))
                            }), a.$on("$destroy", function () {
    ...
    angular.module("ui.grid").factory("Grid", ["$q", "$compile", "$parse", "gridUtil", "uiGridConstants", "GridOptions", "GridColumn", "GridRow", "GridApi", "rowSorter", "rowSearcher", "GridRenderContainer", "$timeout", function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
        ...
        return o.prototype.calcFooterHeight = function () {
            ...
            if (void 0 === a.name && void 0 !== a.field) {
                ...
                if (c) {
                    var d = new RegExp("^" + a.field + "(\\d+)$", "i"), e = b.columns.filter(function (a) {
                        ...
                        if (a === b)return 0;
                        var c = a.match(d)[1], e = b.match(d)[1];
            ...
            var b = this, c = b.processRowsProcessors(b.rows).then(function (a) {
                b.setVisibleRows(a)
            }), d = b.processColumnsProcessors(b.columns).then(function (a) {
                b.setVisibleColumns(a)
            });
            return a.all([c, d]).then(function () {
                b.redrawInPlace(), b.refreshCanvas(!0)
            })
            ...
            return m(f.length > 0 ? function () {
                ...
                for (a = 0; a < f.length; a++)g = f[a], g.headerHeight < i && (g.explicitHeaderHeight = i), g.headerCanvasHeight < j && (g.explicitHeaderCanvasHeight = j);
    ...
    angular.module("ui.grid").factory("GridRenderContainer", ["gridUtil", "uiGridConstants", function (a, b) {
        ...
        }, c.prototype.rowStyle = function (a) {
            var b = this, c = {};
            if (0 === a && 0 !== b.currentTopRow) {
                var d = b.currentTopRow * b.grid.options.rowHeight;
                c["margin-top"] = d + "px"
            }
            return 0 !== b.currentFirstColumn && (b.grid.isRTL() ? c["margin-right"] = b.columnOffset + "px" : c["margin-left"] = b.columnOffset + "px"), c
    ...
    b.constant("uiGridCellNavConstants", {
        ...
        return g
    }]), b.directive("uiGridCellnav", ["gridUtil", "uiGridCellNavService", "uiGridCellNavConstants", function (b, c, d) {
        return {
            replace: !0, priority: -150, require: "^uiGrid", scope: !1, controller: function () {
                ...
                return {
                    pre: function (b, e, f, g) {
                        var h = b, i = g.grid;
                        c.initializeGrid(i), g.cellNav = {}, g.cellNav.focusCell = function (a, b) {
                            g.cellNav.broadcastCellNav({row: a, col: b})
                        }, g.cellNav.broadcastCellNav = i.cellNav.broadcastCellNav = function (a, b) {
                            b = !(void 0 === b || !b), g.cellNav.broadcastFocus(a, b), h.$broadcast(d.CELL_NAV_EVENT, a, b)
                        }, g.cellNav.broadcastFocus = function (b, c) {
                            c = !(void 0 === c || !c);
                            var d = b.row, e = b.col, f = g.grid.api.cellNav.rowColSelectIndex(b);
                            if (null === i.cellNav.lastRowCol || -1 === f) {
                                var h = new a(d, e);
                                i.api.cellNav.raise.navigate(h, i.cellNav.lastRowCol), i.cellNav.lastRowCol = h, g.grid.options.modifierKeysToMultiSelectCells && c ? i.cellNav.focusedCells.push(b) : i.cellNav.focusedCells = [b]
                            } else i.options.modifierKeysToMultiSelectCells && c && f >= 0 && i.cellNav.focusedCells.splice(f, 1)
                        }, g.cellNav.handleKeyDown = function (a) {
                            var b = c.getDirection(a);
                            if (null === b)return !0;
                            var e = "body";
                            a.uiGridTargetRenderContainerId && (e = a.uiGridTargetRenderContainerId);
                            var f = g.grid.api.cellNav.getFocusedCell();
                            if (f) {
                                var h = g.grid.renderContainers[e].cellNav.getNextRowCol(b, f.row, f.col);
                                return h.eventType = d.EVENT_TYPE.KEYDOWN, g.cellNav.broadcastCellNav(h), c.scrollToIfNecessary(i, h.row, h.col), a.stopPropagation(), a.preventDefault(), !1
                            }
                        }
                    }, post: function () {
                    }
        ...
        return {
            priority: -150, restrict: "A", require: "^uiGrid", scope: !1, link: function (b, c, d, e) {
                ...
                e.grid.api.cellNav && b.col.colDef.allowCellFocus && (g(), c.find("div").on("click", function (c) {
                    ...
                    d.row === b.row && d.col === b.col ? (e.grid.options.modifierKeysToMultiSelectCells && g && -1 === e.grid.api.cellNav.rowColSelectIndex(d) ? i() : h(), d.hasOwnProperty("eventType") && d.eventType === f.EVENT_TYPE.KEYDOWN && c.find("div")[0].focus()) : e.grid.options.modifierKeysToMultiSelectCells && g || i()
